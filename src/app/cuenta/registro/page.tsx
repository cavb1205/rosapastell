...
export default function RegisterPage() {
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-5/12 xl:w-[42%] relative overflow-hidden bg-burgundy-500 flex-col items-start justify-between p-14">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-40 -left-40 w-120 h-120 rounded-full bg-white/10" />
          <div className="absolute -bottom-40 -right-32 w-105 h-105 rounded-full bg-white/10" />
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-64 h-64 rounded-full bg-white/10" />
          <div
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-14 bg-white">
        <div className="w-full max-w-130">
          <div className="mb-8">
            <p className="text-xs font-semibold uppercase tracking-widest text-burgundy-400 mb-2">Nueva cuenta</p>
