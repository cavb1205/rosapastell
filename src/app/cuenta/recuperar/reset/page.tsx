      ...
      <div className="flex-1 flex items-center justify-center px-6 py-14 bg-white">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <h1 className="font-heading text-3xl text-warm-900">Nueva contraseña</h1>
          ...
          <p className="mt-8 text-center text-xs text-warm-300">
            ...
            <Link href="/cuenta/ingresar" className="underline hover:text-warm-500 transition-colors">
              Inicia sesión
            </Link>
          </p>
        </div>
